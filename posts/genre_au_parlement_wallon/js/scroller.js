...
function scroller() {
  ...
  function position() {
    ...
    // var pos = h/2 + window.pageYOffset - 10 - containerStart;
    var pos = 9*h/10 + window.pageYOffset - 10 - containerStart;
    var sectionIndex = clamp(d3.bisect(sectionPositions, pos) - 1, 0, sections.size() - 1);
